...
open class CachingPlayerItem: AVPlayerItem {
    ...
    class ResourceLoaderDelegate: NSObject, AVAssetResourceLoaderDelegate, URLSessionDelegate, URLSessionDataDelegate, URLSessionTaskDelegate {
        ...
        private let dataQueue = DispatchQueue(label: "cache.playerItem.mediaData.atomic.queue")
        private var _mediaData: Data?
        var mediaData: Data? {
            get {
                return dataQueue.sync { self._mediaData }
            }
            
            set {
                dataQueue.sync { self._mediaData = newValue }
            }
        }
